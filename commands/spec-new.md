...
- Search for a skill that can be installed to fetch the content (use https://skills.sh/search?q=<query>).
- Ask the user if they want to install the skill or provide alternative sources.
